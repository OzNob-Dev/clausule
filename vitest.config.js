...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      '@feedback': fileURLToPath(new URL('./src/features/feedback', import.meta.url)),
      '@landing': fileURLToPath(new URL('./src/app/(public)/landing', import.meta.url)),
      '@linkedin': fileURLToPath(new URL('./src/features/linkedin', import.meta.url)),
      '@mfa': fileURLToPath(new URL('./src/features/mfa', import.meta.url)),
      '@resume': fileURLToPath(new URL('./src/features/resume', import.meta.url)),

...
- Write copy that is clear, calm, and specific.
- Use plain language before clever language.
- Keep labels and instructions short, but not vague.
...
- Name the missing thing in plain language.
- Give one clear next step.
- Avoid dead-end copy like "Nothing here yet" unless paired with direction.
- Make first-time states feel welcoming, not broken.

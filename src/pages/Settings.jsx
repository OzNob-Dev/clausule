    ...
    <AppShell>
      <div className="px-8 py-8 max-w-xl">
        <div className="mb-6">
          ...
          <p className="text-[13px] text-tm dark:text-[#6B6B68]">Configure when Ledger surfaces HR alerts.</p>
        </div>
        ...
        {/* Sliders */}
        <div className="bg-card dark:bg-card-dark border border-[rgba(0,0,0,0.07)] rounded-ledger p-5 mb-4 flex flex-col gap-5">
          <Slider
        ...
        {/* Actions */}
        <div className="bg-card dark:bg-card-dark border border-[rgba(0,0,0,0.07)] rounded-ledger p-4 mb-6">
        ...
        <div className="mb-6 px-4 py-3 bg-rb rounded-ledger text-[12px] text-rt flex items-start gap-2">
        ...
        <div>
          ...
          <div className="flex flex-col gap-2.5">
            {FLAGGED.map((f) => (
              <div key={f.name} className="flex items-center gap-3 bg-card dark:bg-card-dark border border-[rgba(0,0,0,0.07)] rounded-ledger p-3">
                <div

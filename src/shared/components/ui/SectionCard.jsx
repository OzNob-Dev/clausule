...
export function SectionCard({
  ...
  return (
    <Component className={cn('card overflow-hidden rounded-[16px] bg-[var(--cl-surface-white)] shadow-[var(--cl-shadow-soft),var(--cl-shadow-med)]', className)} aria-label={ariaLabel || undefined} {...props}>

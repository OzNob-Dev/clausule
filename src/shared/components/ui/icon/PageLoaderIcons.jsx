    ...
    <svg className="pl-helix-svg" viewBox="0 0 96 96" fill="none" aria-hidden="true">
      ...
      <g clipPath="url(#pl-helix-clip)">
        <g className="pl-helix-g">
          <path d="M30,4 C38,0 58,8 66,12 C74,16 74,24 66,28 C58,32 38,40 30,44 C22,48 22,56 30,60 C38,64 58,72 66,76 C74,80 74,88 66,92 C58,96 38,104 30,108" stroke="var(--cl-accent-strong)" strokeWidth="3" strokeLinecap="round" fill="none" />
          <path d="M66,4 C58,0 38,8 30,12 C22,16 22,24 30,28 C38,32 58,40 66,44 C74,48 74,56 66,60 C58,64 38,72 30,76 C22,80 22,88 30,92 C38,96 58,104 66,108" stroke="var(--cl-green)" strokeWidth="3" strokeLinecap="round" fill="none" />

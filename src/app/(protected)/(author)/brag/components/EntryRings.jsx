  ...
  return (
    <div className="be-entry-rings" aria-hidden="true">
      ...
      <svg viewBox="0 0 44 44" width="44" height="44" className="be-entry-rings-overlay">
        ...
        <circle cx="22" cy="22" r="6" fill="none" stroke={innerOff >= 37.7 ? 'rgba(180,140,110,0.18)' : 'var(--ring-inner)'} strokeWidth="3.5" strokeDasharray="37.7" strokeDashoffset={innerOff} strokeLinecap="round" transform="rotate(-90 22 22)"/>
      </svg>
    </div>
  )
}

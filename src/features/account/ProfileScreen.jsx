...
const buttonClass = 'min-h-[44px] cursor-pointer rounded-[8px] px-8 py-[11px] font-sans text-[13px] font-bold transition-[background-color,border-color,opacity,color] duration-150 disabled:cursor-default disabled:opacity-45 max-[680px]:w-full'
        ...
        <div className="be-inner max-w-[660px]">
          <form className="rounded-[8px] border border-[rgba(60,45,35,0.1)] bg-card px-[18px] py-4 max-[680px]:p-4" onSubmit={onSubmit}>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-x-3 gap-y-4 max-[680px]:grid-cols-1">
              ...
              <div className="grid grid-cols-2 gap-x-3 gap-y-4 max-[680px]:grid-cols-1">
                <div className={fieldClass(true)}>
                  ...
                  <input
                    ...
                    required
                  />
                  <p className="mt-3 text-[11.5px] font-medium leading-[1.55] text-tm">{emailWarning}</p>
                </div>
                <div className={fieldClass(true)}>
                  ...
                  <input
                    ...
                    required
                  />
                  <p className="mt-3 text-[11.5px] font-medium leading-[1.55] text-tm">Use the number you want tied to account recovery and contact updates.</p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-8 flex items-center justify-end gap-4 border-t border-[rgba(60,45,35,0.1)] pt-5 max-[680px]:flex-col-reverse">

export default function SignInBrandPanel() {
  return (
    <div className="w-[268px] shrink-0 bg-nav flex flex-col justify-start gap-8 py-8 px-7 max-sm:hidden">
      ...
      <div className="mt-auto text-[11px] text-tx-2">Built for teams who care</div>
    </div>
  )
}
